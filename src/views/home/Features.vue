		...
		<v-row>
			<v-col :md="3">
				<v-hover v-slot:default="{ hover }">
					<v-card class="card">
						<v-img class="white--text align-end" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height="170px"
							src="@/assets/image/feature-1.png">
							<v-expand-transition>
								<div v-if="hover" class="d-flex transition-fast-in-fast-out v-card--reveal display-3 white--text"
									style="height: 100%;">
								</div>
							</v-expand-transition>
